...
(function () {
  ...
  function apply(value) {
    ...
    let color=document.querySelector('meta[name=theme-color]');if(!color){color=document.createElement('meta');color.name='theme-color';document.head.append(color);}color.content=document.documentElement.dataset.theme==='dark'?'#141827':'#F1F3FA';
